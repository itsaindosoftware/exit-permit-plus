            ...
            <div className="space-y-6">
                <div className="rounded-2xl border border-cyan-200 bg-gradient-to-r from-cyan-50 via-slate-50 to-white p-5 shadow-sm">
                    ...
                    <p className="mt-2 max-w-4xl text-sm text-slate-700">
                        The form structure below follows the manual Exit Permit document format. Data entered here
                        is directly connected to the approval and reimbursement system.
                    </p>
                ...
                >
                    ...
                    <div className="space-y-5 px-4 py-5 md:px-6">
                        ...
                        <div className="flex items-center justify-between gap-3 rounded-md border border-slate-200 bg-slate-50 px-3 py-2">
                            <p className="text-xs text-slate-600 md:text-sm">Add or remove rows based on the number of requestors.</p>
                            <button
                                type="button"
                        ...
                        <div className="grid gap-4 rounded-lg border border-slate-200 bg-slate-50 p-4 md:grid-cols-2">
                            ...
                            <div>
                                <label className="text-sm font-semibold text-slate-800">Exit Permit Type</label>
                        ...
                        <div>
                            <div>
                                ...
                                <input
                                    ...
                                    disabled={isPersonalExitType}
                                    onChange={(e) => setData('destination', e.target.value)}
                                    placeholder="Example: Clinic, dealer, vendor office"
                                />
                        ...
                        {isCompanyExitType && (
                            <div>
                                ...
                                <div className="mt-4">
                                    <label htmlFor="cost_center_id" className="text-sm font-semibold text-slate-800">Cost Center (Department)</label>
                                    <select
                                        id="cost_center_id"
                                        className={inputClass}
                        ...
                        {!isCompanyExitType && (
                            <div className="rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-600">
                                The Order Car field is only for Assignment / Company exit permits.
                            </div>
                        )}
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Explain the reason for leaving, agenda, and estimated activities."
                            />
                        ...
                        <div>
                            ...
                            />
                            <p className="mt-1 text-xs text-slate-500">Image formats: JPG, JPEG, PNG, WEBP. Max size 2MB.</p>
