            ...
            <div className="space-y-6">
                <div className="rounded-xl border border-indigo-200 bg-indigo-50 p-5 shadow-sm">
                    <p className="text-sm text-indigo-900">
                        Select an Exit Permit with Order Car = Yes, then choose the license plate and driver.
                    </p>
                </div>

                {targets.length === 0 ? (
                    <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
                        No Exit Permit pending arrangement.
                    </div>
                ) : (
                    <form onSubmit={submit} className="space-y-4 rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        <div className="rounded-lg border border-cyan-200 bg-cyan-50 p-4">
                            ...
                            <p className="mt-1 text-xs text-cyan-700">Data is auto-filled from the Exit Permit, but can be edited manually if there are mistakes.</p>
